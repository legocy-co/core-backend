...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/legocy-go_internal_delievery_http_resources_users.UserProfilePageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "legocy-go_internal_delievery_http_resources_users.UserProfilePageResponse": {
            "type": "object",
            "properties": {
                "marketItems": {
                    "type": "array",
